...
gpd.GeoDataFrame(shapefiles_loaded_viirs_375m, geometry=shapefiles_loaded_viirs_375m.geometry, crs=pyproj.CRS('EPSG:28992')).to_file(viirs_shapefile_path_375m + "//filtered_pixels_VIIRS_375M_v2.shp")
